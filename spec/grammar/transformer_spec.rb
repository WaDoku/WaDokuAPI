...
describe HTMLTransform do
  ...
  it 'transforms complete entries' do
    ...
    res = transformer.apply(tree)
    expect(res).to eq("(<span class='pos'>N.</span>) <span class='mgr'><span class='dom'>Bot.</span>; <span class='tre'><span class='hw'>Artischocke <span class='genus f'>f</span></span></span>; (<span class='scientif'>Cynara scolymus</span>)</span>.")
    ...
    text = '(<POS: N.>) <MGr: {<Dom.: Stadtn.>} <TrE: <HW nNAr: Okazaki>>> (<Def.: Stadt in der Präf. Aichi in der Chūbu-Region>；<Expl.: ehem. Burgstadt>；<Expl.: 322.000 Ew.>；<Expl.: Textil‑, Kunstfaser‑, Nahrungsmittelindustrie>).'
    tree = grammar.parse(text)
    res = transformer.apply(tree)
    expect(res).to eq("(<span class='pos'>N.</span>) <span class='mgr'><span class='dom'>Stadtn.</span>; <span class='tre'><span class='hw'>Okazaki <span class='genus nNAr'>nNAr</span></span></span></span>. (<span class='def'>Stadt in der Präf. Aichi in der Chūbu-Region</span>; <span class='expl'>ehem. Burgstadt</span>; <span class='expl'>322.000 Ew.</span>; <span class='expl'>Textil‑, Kunstfaser‑, Nahrungsmittelindustrie</span>).")
