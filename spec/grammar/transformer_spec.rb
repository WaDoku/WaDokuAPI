...
describe HTMLTransform do
  ...
  it "should transform complete entries" do
    ...
    res = transformer.apply(tree)
    res.should == "(<span class='pos'>N.</span>) <span class='mgr'><span class='dom'>Bot.</span>; <span class='tre'><span class='hw'>Artischocke <span class='genus f'>f</span></span></span>; (<span class='scientif'>Cynara scolymus</span>)</span>."
